...
instead of raw pointer arithmetic. K is transposed virtually via
order=(0,1) on a (BLOCK_D, BLOCK_N) block, eliminating tl.trans.
"""
...
def _fwd_kernel_prefill(
    ...
    # K is presented as transposed view (BLOCK_D, BLOCK_N) via order=(0,1) — Snippet A
